...
% TODO: I mention the control mapping or correspondense building a couple of times. - this is ergonomics and knowledge building respectively?

\chapter{Experiments}

% TODO: shouldn't there be a Contept introductionary part, where I describe the idea for the last experiment, and that implicitly explains the need for the pilot studies. Different parts of the concept are the focus of the differnt studies conducted. The concept part can be smallish, and as a list or a table, too. <==================================================== I feel like this should be just spread out through the studies. 
...
% TODO: specify that pilots and the final studies are not really CVEs, but are meant to simulate one
