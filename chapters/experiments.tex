...
\begin{comment}
	...
	\subfloat[Predefined translation paths]{
		...
		\includegraphics[width=0.3\linewidth]{figures/pilot1_predefined_tutorial_translations}
	} %
...
\begin{figure}
	...
	\subfloat[Tracing shape]{\includegraphics[width=0.55\linewidth]{figures/finalstudy_voxeldrawing1}}
	\par \smallskip
	\subfloat[Partially traced shape]{\includegraphics[width=0.55\linewidth]{figures/finalstudy_voxeldrawing2}}
	\par \smallskip
	\subfloat[Tracing shape and voxel drawing side-by-side]{\includegraphics[width=0.55\linewidth]{figures/finalstudy_voxeldrawing3}}
...
\paragraph{Discussion}
The visual analysis (Fig. \ref{fig:distributions_freqReaction0}) shows that approx. $1/4$th of all the translations were not caught: 11 from Group 1, 19 from Group 2, and 26 from Group 3. % TODO: label multiple times defined?
...
\begin{figure}[h]
	\centering
	\subfloat{\includegraphics[width=0.9\linewidth]{figures/finalstudy_minimap_around2}}
